...
namespace BVNetwork.NotFound.Core.Initialization
{
    ...
    public class Custom404HandlerInitialization : IInitializableHttpModule
    {
        ...
        {
            context.EndRequest += FileNotFoundHandler;
        ...
        public void Initialize(InitializationEngine context)
        {
            ...
            //  HttpContext.Current.ApplicationInstance.EndRequest += FileNotFoundHandler;
        ...
        {
            application.EndRequest += FileNotFoundHandler;
        }
    }
}